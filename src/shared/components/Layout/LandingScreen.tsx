    ...
    <>
      ...
      >
       ...
       {mode ==="landing" &&  <Box marginBottom={"lg"} rowGap={"xs"} paddingHorizontal={"md"} >
            ...
            <PrimaryButton  btnTitleProps={{color:"textColorInverted"}}  title='Register' btnBoxProps ={{backgroundColor:"transparent",borderWidth:1,borderColor:"textColorInverted"}} />
