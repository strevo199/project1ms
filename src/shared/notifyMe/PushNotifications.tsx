...
import {
  ...
  setHasEnabledPushNotification,
  setPushNotificationStatus,
} from '@shared/utilities/functions/pushNotification';
...
//         setHasEnabledPushNotification(false);
//         setPushNotificationStatus('I');
//       });
//   }
// }

export const checkApplicationNotificationPermission =
  async (): Promise<void> => {
    ...
    if (enabled) {
      ...
      setHasEnabledPushNotification(true);
    } else {
      setHasEnabledPushNotification(false);
    }
...
export const getFcmToken = async (): Promise<string | null> => {
  ...
  const storedToken = getFirebaseMessagingToken();
  console.log({os:Platform.OS,storedToken});
  ...
  if (storedToken) {
    ...
    try {
      ...
      if (token) {
        setFirebaseMessagingToken(token);
      }
    } catch {
